...
SELECT 'non_positive' AS anomaly_type, task_id, start_status, started_at, end_status, ended_at, resolution_time_min
FROM periods
WHERE resolution_time_min <= 0
UNION ALL
SELECT 'too_long_gt_30d' AS anomaly_type, task_id, start_status, started_at, end_status, ended_at, resolution_time_min
FROM periods
WHERE resolution_time_min > 43200
ORDER BY anomaly_type, resolution_time_min DESC
LIMIT 100;
