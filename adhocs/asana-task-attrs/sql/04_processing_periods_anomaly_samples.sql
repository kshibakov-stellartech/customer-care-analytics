...
SELECT 'non_positive' AS anomaly_type, task_id, started_at, ended_at, resolution_time_min
FROM periods
WHERE resolution_time_min <= 0
UNION ALL
SELECT 'too_long_gt_30d' AS anomaly_type, task_id, started_at, ended_at, resolution_time_min
FROM periods
