...
history_wide AS (
  SELECT
    ...
    max_by(current_value, event_at) FILTER (WHERE regexp_like(lower(changed_field), 'resolut(i)?on type')) AS last_resolution_type,
...
SELECT *
FROM res
WHERE task_id = '1214391530882193'
